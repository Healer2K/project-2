...
export default {
  ...
  watch:{
      'cForm.category1Id'(newValue,oldValue){
        //   console.log('1id发生改变',newValue,oldValue)
            this.handler1()
      },
      'cForm.category2Id'(newValue,oldValue){
        //   console.log('2id发生改变',newValue,oldValue)
            this.handler2()
      },
      'cForm.category3Id'(newValue,oldValue){
        //   console.log('3id发生改变',newValue,oldValue)
            this.handler3()
      },
      deep:true
  },
